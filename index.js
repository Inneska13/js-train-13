...
function searchParamsURL(url) {
  ...
  // Кожен 'param' - це масив, де [0] - ім'я параметра, а [1] - значення
  return params;
  // Повертаємо словник
}
...
function getUrlKeys(url) {
  ...
  let paramsArray = Array.from(urlObj.searchParams.keys());
